  ...
  <style>
    ...
    * {{ box-sizing: border-box; }}
    ...
    .analysis-cta {{
      ...
      margin-top: 22px;
      padding: 12px 15px;
      border: 1px solid rgba(86, 214, 201, 0.42);
      color: var(--teal);
      text-decoration: none;
      font-size: 0.72rem;
      letter-spacing: 0.12em;
      text-transform: uppercase;
      background: rgba(86, 214, 201, 0.06);
    ...
    <section class=\"hero\">
      <div class=\"hero-copy\">
        <div>
          ...
          <a class=\"analysis-cta\" href=\"scientific-analysis.html\">Open scientific evidence review <span aria-hidden=\"true\">→</span></a>
        </div>
        <div class=\"hero-meta\">
