...
DEFAULT_BASE_URL = os.getenv("UFO_REVIEW_BASE_URL", "http://localhost:4321/v1")
DEFAULT_MODEL = os.getenv("UFO_REVIEW_MODEL", "Qwen3.6-35B-A3B-UD-MLX-4bit")
DEFAULT_API_KEY = os.getenv("UFO_REVIEW_API_KEY")
